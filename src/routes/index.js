      ...
      children: [
...

        {
          ...
          children: [
            ...
            { path: 'product/:name/:code', element: <EcommerceProductDetails /> },
            { path: 'order/list', element: <EcommerceOrderList /> },
            { path: 'order/:code', element: <EcommerceOrder /> },
...
const EcommerceOrder= Loadable(lazy(() => import('../pages/dashboard/EcommerceOrder')));

...
const [productLists, setProductLists] = useState([]);
  ...
  const { product, loading, error, data , pages } = productList;
...
{!loading && productLists?<ShopProductList products={productLists} loading={loading && isDefault} /> :<ShopProductList products={products} loading={!loading && isDefault} />}
